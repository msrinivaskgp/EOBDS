...
with open('C:\\Users\\M.S\\Documents\\CTRF-main\\CTRF-main\\CTRF\\CTRF\\CTRF\\Output\\dt1.pickle', 'rb') as file:
    dt = pickle.load(file)
# Load the saved result from the file
with open('C:\\Users\\M.S\\Documents\\CTRF-main\\CTRF-main\\CTRF\\CTRF\\CTRF\\Output\\test1.pickle', 'rb') as file:
    winetest = pickle.load(file)
with open('C:\\Users\\M.S\\Documents\\CTRF-main\\CTRF-main\\CTRF\\CTRF\\CTRF\\Output\\bf1.pickle', 'rb') as file:
    bf = pickle.load(file)
with open('C:\\Users\\M.S\\Documents\\CTRF-main\\CTRF-main\\CTRF\\CTRF\\CTRF\\Output\\eo1.pickle', 'rb') as file:
    mt = pickle.load(file)
...
acc_3,arg_1, and_1, or_1,count_s1,count_d1,count_c1,time1 = bds_Func.predict_bds(dt,bf, winetest)
acc_4,arg_2, and_2, or_2,count_s2,count_d2,count_c2,time2 = bds_Func.predict_obds(dt, mt, winetest)
acc_5,arg_3, and_3, or_3,count_s3,count_d3,count_c3,time3 = bds_Func.predict_eobds(dt, mt, winetest)
...
"""
import csv
file_path = 'C:\\Users\\M.S\\Documents\\CTRF-main\\CTRF-main\\CTRF\\CTRF\\CTRF\\Output\\file.csv'  # Replace this with the actual path to your CSV file
with open(file_path, 'a', newline='') as csvfile:
    csv_writer = csv.writer(csvfile)
    csv_writer.writerow([acc1,acc2,acc_3,acc_4,acc_5,sum(hist_node)-sum(hist_leaf),sum(var1)-sum(var2),and_1,or_1,and_2,or_2,and_3,or_3,count_s1,count_d1,count_c1,count_s2,count_d2,count_c2,count_s3,count_d3,count_c3,time1,time2,time3])
